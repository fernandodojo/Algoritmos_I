...
function love.load()
	...
	char2 = {}
	char2.b = love.physics.newBody(mundo, 400, 400, "dynamic")
	char2.s = love.physics.newRectangleShape(40, 70)
	char2.f = love.physics.newFixture(char2.b, char2.s)
	char2.f:setRestitution(0.7)
...
function love.draw()
   ...
   love.graphics.polygon("fill", char2.b:getWorldPoints(char2.s:getPoints()))
